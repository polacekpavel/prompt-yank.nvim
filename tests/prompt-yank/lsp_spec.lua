  ...
  describe("yank_with_definitions_deep", function()
    it("copies selection when no definitions are found", function()
      ...
      local text = stub(lsp, {
        ...
        return py.yank_with_definitions_deep({ from_visual = true, notify = false, register = '"' })
      end)
  ...
  describe("yank_with_definitions_deep edge cases", function()
    ...
    it("includes all depth levels in output", function()
      ...
      local text = stub(lsp, {
        get_definitions_deep = function()
          return {
            { name = "a", filepath = root .. "/a.lua", start_line = 1, end_line = 2, code = "function a() return b() end", depth = 1 },
            { name = "b", filepath = root .. "/b.lua", start_line = 1, end_line = 2, code = "function b() return c() end", depth = 2 },
            { name = "c", filepath = root .. "/c.lua", start_line = 1, end_line = 2, code = "function c() return 1 end", depth = 3 },
          }
        end,
      }, function()
        return py.yank_with_definitions_deep({ from_visual = true, notify = false, register = '"' })
